...
const StockAbnormalSignals = () => {
    ...
    const { abnormalities, performance, immediate } = data;
    ...
    return (
        <div className="space-y-6">
            ...
            <SignalInterpretationGuide variant="stock" />
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between">
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">
                            Tín hiệu bất thường cổ phiếu gần đây
                        </h3>
                        <span className="text-sm text-gray-500 dark:text-gray-400">
                            {abnormalities?.length || 0} tín hiệu
                        </span>
                    </div>
...
export default StockAbnormalSignals; 